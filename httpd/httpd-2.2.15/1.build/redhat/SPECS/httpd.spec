...
Patch3: httpd-2.2.14-deplibs.patch
...
# Bug fixes
Patch50: httpd-2.2.14-encode.patch
Patch54: httpd-2.2.0-authnoprov.patch
Patch57: httpd-2.0.52-logresline.patch
# Custom Patches
Patch300: httpd-2.2.14-busyness_retry.patch
Patch301: httpd-2.2.14-busyness_status.patch
...
%patch300 -p1 -b .busyness_retry
%patch301 -p1 -b .busyness_status
...
%changelog
* Tue Jun 08 2010 Yuta Kiriyama <y-kiriyama@asteriks.co.jp>
- version up from 2.2.14 to 2.2.15

* Thu Dec 22 2009 Yuta Kiriyama <y-kiriyama@asteriks.co.jp>
- version up from 2.2.3 to 2.2.14

* Mon Jul  6 2009 Joe Orton <jorton@redhat.com> 2.2.3-22.el5_3.2
- add security fixes for CVE-2009-1890, CVE-2009-1891 (#509782)

* Thu May  7 2009 Joe Orton <jorton@redhat.com> 2.2.3-22.el5_3.1
